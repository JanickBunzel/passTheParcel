...
The buttons on the upper right side help the users to filter the parcels for relevant criteria ![Filter](https://raw.githubusercontent.com/JanickBunzel/passTheParcel/main/FilterPassTheParcel.png)
